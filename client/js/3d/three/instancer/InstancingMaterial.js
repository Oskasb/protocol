...
define([
    ...
    function(
        ...
        var InstancingMaterial = function(systemOptions, txMatSettings, readyCallback) {
    ...
    //        console.log("new ParticleMaterial, count:", matCount);
        ...
        InstancingMaterial.prototype.setupMaterial = function() {
    ...
    //            console.log("GLOBAL UNIFORMS: ", uniforms, addUniforms);
        ...
        InstancingMaterial.prototype.configureTxSettings = function() {
            configureTXSettings(this.txSettings, this.txMatSettings);

        };

        InstancingMaterial.prototype.setupShaders = function() {
        ...
        InstancingMaterial.prototype.setupMapTexture = function() {
        ...
        InstancingMaterial.prototype.setupDataTexture = function() {
        ...
        InstancingMaterial.prototype.dispose = function() {
